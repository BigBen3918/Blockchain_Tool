...
const Provider = new ethers.providers.JsonRpcProvider(process.env.RPC_2);

const sendOneTransactions = async (amount,index,max) => {
...
const sendTransactions = (start,end,txNum)=>{
    ...
    sendOneTransactions("0.0000001",i,txNum)
    .then(() => {
